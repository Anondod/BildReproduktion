...
if size(y,1) < size(y,2)%changed x to y by A
    y = y';
end
...
mask(border==1) = 0;%added by A

%https://se.mathworks.com/matlabcentral/fileexchange/43032-convert-voronoi-cells-to-region-mask